...
describe('myApp', function () {
  ...
  beforeEach(inject(function ($controller, $rootScope, _dataFactory_, _calculateFactory_) {
  ...
  describe('Data Factory', function () {
    it("should return [{name: 'Adrian Peterson', value: 4}, {name: 'Carson Palmer', value: 2}] given team1", function () {
      expect(dataFactory.getTeamData('team1')).toEqual([{name: 'Adrian Peterson', value: 4}, {name: 'Carson Palmer', value: 2}]);
    });
    it("should return [{name: 'Antonio Brown', value: 5}] given team2", function () {
      expect(dataFactory.getTeamData('team2')).toEqual([{name: 'Antonio Brown', value: 5}]);
    });
  });
  describe('Calc Factory', function () {
    it("should return 6 given [{name: 'Adrian Peterson', value: 4}, {name: 'Carson Palmer', value: 2}]", function () {
      expect(calculateFactory.calcTeamValue([{name: 'Adrian Peterson', value: 4}, {name: 'Carson Palmer', value: 2}])).toEqual(6);
    });
    it("should return 5 given [{name: 'Antonio Brown', value: 5}]", function () {
      expect(calculateFactory.calcTeamValue([{name: 'Antonio Brown', value: 5}])).toEqual(5);
    });
  });
});
